        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-1 space-y-8 lg:sticky lg:top-28">
            ...
            <p className="text-sm font-light text-luxury-muted leading-relaxed">
              Every piece in our collection is thoughtfully crafted with an emphasis
              on quality, detail, and timeless design — created to be cherished for years to come.
            </p>
          ...
          <LayoutGroup>
            <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-12">
              ...
              {featuredProducts.map((product) => (
                <div key={String(product.id)} className="space-y-4">
                  <ProductCard
                    product={product}
                    settings={settings}
                  />
