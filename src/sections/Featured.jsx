...
export default function Featured({ products, settings }) {
  ...
  return (
    <section id="collections" className="py-24 bg-luxury-champagne/30 border-y border-luxury-champagne/20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-1 space-y-8 sticky top-28">
            <div className="space-y-3">
              ...
              <h2 className="text-4xl md:text-5xl font-serif font-light text-luxury-black leading-tight">
                Featured Pieces
              </h2>
            </div>
            
            <p className="text-sm font-light text-luxury-muted leading-relaxed">
              Every creation in our collection is meticulously handcrafted by skilled artisans. We source only the finest fabrics, authentic pearls, and premium stationery paper to ensure your keepsake stands the test of time.
            </p>
