...
export default function Contact({ settings }) {
  ...
  const handleSubmit = (e) => {
    ...
    const subject = `Custom-made Inquiry from ${formData.name}`;
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-28 items-start">
        ...
        <div className="space-y-12">
          ...
          <p className="text-sm font-light text-luxury-muted leading-7 max-w-md">
            Each piece is thoughtfully designed and handcrafted to bring your vision to life with elegance, artistry, and refined detail.
          </p>
